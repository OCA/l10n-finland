Go to a Sales journal from Invoicing configuration verify that "Finvoice 3.0" is selected as Electronic invoicing.
After that, a Finvoice document should be generated when an invoice is confirmed.
